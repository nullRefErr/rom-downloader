...
static void kb_event_cb(lv_event_t *e) {
    ...
    if (g_step == ST_EMAIL) {
        ...
        set_status("Now enter your password, then press the check again", 0x888888);
